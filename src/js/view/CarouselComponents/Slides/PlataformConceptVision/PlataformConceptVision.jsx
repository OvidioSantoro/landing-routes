	...
	<div className="carousel-item">
		...
		<div className="carousel-caption d-none d-md-block Plat">
			...
			<p>
				...
				230 km/h (143 mph), and a range of 1,000 km + (620 miles +) for
				a filling time of only
				<b>3</b>
				minutes. These technical feats are made possible by a set of
				innovations and the harmonious stratification of the different
